...
class GetServiceEntryResponse_Status extends $pb.ProtobufEnum {
  static const GetServiceEntryResponse_Status STATUS_UNKNOWN = GetServiceEntryResponse_Status._(0, 'STATUS_UNKNOWN');
  static const GetServiceEntryResponse_Status STATUS_OK = GetServiceEntryResponse_Status._(1, 'STATUS_OK');
  static const GetServiceEntryResponse_Status STATUS_NONEXISTENT_SERVICE = GetServiceEntryResponse_Status._(2, 'STATUS_NONEXISTENT_SERVICE');
