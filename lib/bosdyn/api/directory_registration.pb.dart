...
class RegisterServiceRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RegisterServiceRequest', package: const $pb.PackageName('bosdyn.api'), createEmptyInstance: create)
    ..aOM<$19.RequestHeader>(1, 'header', subBuilder: $19.RequestHeader.create)
    ..aOM<$2.Endpoint>(2, 'endpoint', subBuilder: $2.Endpoint.create)
    ..aOM<$2.ServiceEntry>(3, 'serviceEntry', subBuilder: $2.ServiceEntry.create)
  ...
  RegisterServiceRequest copyWith(void Function(RegisterServiceRequest) updates) => super.copyWith((message) => updates(message as RegisterServiceRequest));
  ...
  @$pb.TagNumber(2)
  $2.Endpoint get endpoint => $_getN(1);
  @$pb.TagNumber(2)
  set endpoint($2.Endpoint v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasEndpoint() => $_has(1);
  @$pb.TagNumber(2)
  void clearEndpoint() => clearField(2);
  @$pb.TagNumber(2)
  $2.Endpoint ensureEndpoint() => $_ensure(1);

  @$pb.TagNumber(3)
  $2.ServiceEntry get serviceEntry => $_getN(2);
  @$pb.TagNumber(3)
  set serviceEntry($2.ServiceEntry v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasServiceEntry() => $_has(2);
  @$pb.TagNumber(3)
  void clearServiceEntry() => clearField(3);
  @$pb.TagNumber(3)
  $2.ServiceEntry ensureServiceEntry() => $_ensure(2);
}

class RegisterServiceResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RegisterServiceResponse', package: const $pb.PackageName('bosdyn.api'), createEmptyInstance: create)
    ..aOM<$19.ResponseHeader>(1, 'header', subBuilder: $19.ResponseHeader.create)
    ..e<RegisterServiceResponse_Status>(2, 'status', $pb.PbFieldType.OE, defaultOrMaker: RegisterServiceResponse_Status.STATUS_UNKNOWN, valueOf: RegisterServiceResponse_Status.valueOf, enumValues: RegisterServiceResponse_Status.values)
    ..hasRequiredFields = false
  ;
  ...
  RegisterServiceResponse copyWith(void Function(RegisterServiceResponse) updates) => super.copyWith((message) => updates(message as RegisterServiceResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UnregisterServiceRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UnregisterServiceRequest', package: const $pb.PackageName('bosdyn.api'), createEmptyInstance: create)
    ..aOM<$19.RequestHeader>(1, 'header', subBuilder: $19.RequestHeader.create)
    ..aOS(2, 'serviceName')
    ..hasRequiredFields = false
  ;
  ...
  UnregisterServiceRequest copyWith(void Function(UnregisterServiceRequest) updates) => super.copyWith((message) => updates(message as UnregisterServiceRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UnregisterServiceResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UnregisterServiceResponse', package: const $pb.PackageName('bosdyn.api'), createEmptyInstance: create)
    ..aOM<$19.ResponseHeader>(1, 'header', subBuilder: $19.ResponseHeader.create)
    ..e<UnregisterServiceResponse_Status>(2, 'status', $pb.PbFieldType.OE, defaultOrMaker: UnregisterServiceResponse_Status.STATUS_UNKNOWN, valueOf: UnregisterServiceResponse_Status.valueOf, enumValues: UnregisterServiceResponse_Status.values)
    ..hasRequiredFields = false
  ;
  ...
  UnregisterServiceResponse copyWith(void Function(UnregisterServiceResponse) updates) => super.copyWith((message) => updates(message as UnregisterServiceResponse));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UpdateServiceRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UpdateServiceRequest', package: const $pb.PackageName('bosdyn.api'), createEmptyInstance: create)
    ..aOM<$19.RequestHeader>(1, 'header', subBuilder: $19.RequestHeader.create)
    ..aOM<$2.Endpoint>(2, 'endpoint', subBuilder: $2.Endpoint.create)
    ..aOM<$2.ServiceEntry>(3, 'serviceEntry', subBuilder: $2.ServiceEntry.create)
    ..hasRequiredFields = false
...
class UpdateServiceResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UpdateServiceResponse', package: const $pb.PackageName('bosdyn.api'), createEmptyInstance: create)
    ..aOM<$19.ResponseHeader>(1, 'header', subBuilder: $19.ResponseHeader.create)
    ..e<UpdateServiceResponse_Status>(2, 'status', $pb.PbFieldType.OE, defaultOrMaker: UpdateServiceResponse_Status.STATUS_UNKNOWN, valueOf: UpdateServiceResponse_Status.valueOf, enumValues: UpdateServiceResponse_Status.values)
    ..hasRequiredFields = false
  ;
